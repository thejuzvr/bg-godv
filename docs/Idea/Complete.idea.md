...
Давай создадим игру аналог godville.net в мире The Elder Scrolls - Skyrim.
Упор игры на auto-rpg, где персонаж самостоятельно развивается. 
Мы лишь можем как боги влиять на него через Благословение, наказание и сообщение.

Нужно создать основные функции. 
1) Регистрация\вход - Создание персонажа.
2) Dashboard: Журнал приключение, окна состояния, прогресс бар с заданиями
3) Фракции
4) Боевые механики
5) Карта мира
И что-то что ты сам обдумаешь. Упор на русский язык. Так же нужно добавить юморных записей, мыслей, заданий.




Основные задачи:
# Complete - 1) Распределить мысли и диалоги - категоризация (Если я выполняю задание, мысли такие| Если я дерусь, мысли другие / В путешествии мысли такие | и.т.д);
# Complete - 3) Улучшить генераторы заданий + генераторы events
